...
pip3 install cmake;pip3 install face_recognition;obavezno ovim redom
Iz prve dvije slike uči lice, na trećoj ih prepoznaje
"""
import os
import cv2
...
biden_image = face_recognition.load_image_file("fajlovi/biden.jpg")
...
unknown_image = face_recognition.load_image_file("fajlovi/two_people.jpg")
